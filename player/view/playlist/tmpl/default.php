  ...
  <div id="items">
    ...
    ?>
     ...
     <?php for($i=0;$i<count($dirs);$i++) {?>
	  ...
	  <?php } else {?>
		<td id="file"><?php echo htmlentities(cut_file($dirs[$i]['name']));?></td><td><a href="index.php?view=edit_playlist&task=addfile&item=<?php echo $dirs[$i]['name'];?>&dir=<?php echo $dir;?>#<?php echo $i;?>"><img width="15" src="images/plus.png"></a></td>
	  <?php } ?>
